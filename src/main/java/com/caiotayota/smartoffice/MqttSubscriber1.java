...
public class MqttSubscriber1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Subscribe to the "floor/room/temperature" topic to receive messages
            sampleClient.subscribe("floor/room/temperature");

            // Keep the application running to listen for messages
            System.out.println("Listening for messages on 'floor/room/temperature'...");
